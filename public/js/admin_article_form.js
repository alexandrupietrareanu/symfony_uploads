...
class ReferenceList
{
    ...
    handleReferenceDelete(event) {
        ...
        $.ajax({
            url: 'http://127.0.0.1/uploads/public/admin/article/references/'+id,
            method: 'DELETE'
        }).then(() => {
...
<li class="list-group-item d-flex justify-content-between align-items-center" data-id="${reference.id}">
    ...
    <span>
        <a href="http://127.0.0.1/uploads/public/admin/article/references/${reference.id}/download" class="btn btn-link btn-sma"><span class="fa fa-download"></span></a>
